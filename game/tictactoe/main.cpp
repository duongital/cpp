  ...
  while (!WindowShouldClose()) {
    ...
    if (Scene == 1) {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) {
        if (mousePos.x >= 50 && mousePos.x <= 250 && mousePos.y >= 100 &&
            mousePos.y <= 150) {
          Scene = 2;
          Pressed = true;
          PlaySound(BtnPress);
        }
        if (mousePos.x >= 50 && mousePos.x <= 250 && mousePos.y >= 175 &&
            mousePos.y <= 225) {
          DarkMode = !DarkMode;
          PlaySound(BtnPress);
        }
        if (mousePos.x >= 50 && mousePos.x <= 250 && mousePos.y >= 250 &&
            mousePos.y <= 300) {
          Scene = 3;
          PlaySound(BtnPress);
        }
        if (mousePos.x >= 50 && mousePos.x <= 250 && mousePos.y >= 325 &&
            mousePos.y <= 375) {
          PlaySound(BtnPress);
          CloseWindow();
        }
    ...
    if (Scene == 2) {
      ...
      if (!DarkMode) {
        ...
        // Grid
        DrawRectangle(screenWidth / 2 - 55, screenHeight / 2 - 137.5, 10, 275,
                      BLACK);
        DrawRectangle(screenWidth / 2 + 45, screenHeight / 2 - 137.5, 10, 275,
                      BLACK);
        DrawRectangle(screenWidth / 2 - 137.5, screenHeight / 2 - 55, 275, 10,
                      BLACK);
        DrawRectangle(screenWidth / 2 - 137.5, screenHeight / 2 + 45, 275, 10,
                      BLACK);
      }
      if (DarkMode) {
        DrawTexture(BackgroundImageDark, 0, 0, WHITE);
      ...
      switch (Squares[0]) {
        case 0:
          DrawTexture(BlankTile, screenWidth / 2 - 137.5,
                      screenHeight / 2 - 137.5, RAYWHITE);
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 - 137.5, screenHeight / 2 - 137.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 - 137.5, screenHeight / 2 - 137.5,
                      BLUE);
          break;
      }
      switch (Squares[1]) {
        case 0:
          DrawTexture(BlankTile, screenWidth / 2 - 37.5,
                      screenHeight / 2 - 137.5, RAYWHITE);
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 - 37.5, screenHeight / 2 - 137.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 - 37.5, screenHeight / 2 - 137.5,
                      BLUE);
          break;
      }
      switch (Squares[2]) {
        case 0:
          DrawTexture(BlankTile, screenWidth / 2 + 62.5,
                      screenHeight / 2 - 137.5, RAYWHITE);
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 + 62.5, screenHeight / 2 - 137.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 + 62.5, screenHeight / 2 - 137.5,
                      BLUE);
          break;
      }
      switch (Squares[3]) {
        case 0:
          DrawTexture(BlankTile, screenWidth / 2 - 137.5,
                      screenHeight / 2 - 37.5, RAYWHITE);
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 - 137.5, screenHeight / 2 - 37.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 - 137.5, screenHeight / 2 - 37.5,
                      BLUE);
          break;
      }
      switch (Squares[4]) {
        case 0:
          ...
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 - 37.5, screenHeight / 2 - 37.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 - 37.5, screenHeight / 2 - 37.5,
                      BLUE);
          break;
      }
      switch (Squares[5]) {
        case 0:
          ...
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 + 62.5, screenHeight / 2 - 37.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 + 62.5, screenHeight / 2 - 37.5,
                      BLUE);
          break;
      }
      switch (Squares[6]) {
        case 0:
          DrawTexture(BlankTile, screenWidth / 2 - 137.5,
                      screenHeight / 2 + 62.5, RAYWHITE);
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 - 137.5, screenHeight / 2 + 62.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 - 137.5, screenHeight / 2 + 62.5,
                      BLUE);
          break;
      }
      switch (Squares[7]) {
        case 0:
          ...
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 - 37.5, screenHeight / 2 + 62.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 - 37.5, screenHeight / 2 + 62.5,
                      BLUE);
          break;
      }
      switch (Squares[8]) {
        case 0:
          ...
          break;
        case 1:
          DrawTexture(Cross, screenWidth / 2 + 62.5, screenHeight / 2 + 62.5,
                      MAROON);
          break;
        case 2:
          DrawTexture(Circle, screenWidth / 2 + 62.5, screenHeight / 2 + 62.5,
                      BLUE);
          break;
      }
      if (!IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT) && !GameOver && !Pressed) {
        if (mousePos.x >= 12.5 && mousePos.x <= 87.5 && mousePos.y >= 62.5 &&
            mousePos.y <= 137.5 && Squares[0] == 0) {
          Squares[0] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 112.5 && mousePos.x <= 187.5 && mousePos.y >= 62.5 &&
            mousePos.y <= 137.5 && Squares[1] == 0) {
          Squares[1] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 212.5 && mousePos.x <= 287.5 && mousePos.y >= 62.5 &&
            mousePos.y <= 137.5 && Squares[2] == 0) {
          Squares[2] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 12.5 && mousePos.x <= 87.5 && mousePos.y >= 162.5 &&
            mousePos.y <= 237.5 && Squares[3] == 0) {
          Squares[3] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 112.5 && mousePos.x <= 187.5 && mousePos.y >= 162.5 &&
            mousePos.y <= 237.5 && Squares[4] == 0) {
          Squares[4] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 212.5 && mousePos.x <= 287.5 && mousePos.y >= 162.5 &&
            mousePos.y <= 237.5 && Squares[5] == 0) {
          Squares[5] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 12.5 && mousePos.x <= 87.5 && mousePos.y >= 262.5 &&
            mousePos.y <= 337.5 && Squares[6] == 0) {
          Squares[6] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 112.5 && mousePos.x <= 187.5 && mousePos.y >= 262.5 &&
            mousePos.y <= 337.5 && Squares[7] == 0) {
          Squares[7] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
        }
        if (mousePos.x >= 212.5 && mousePos.x <= 287.5 && mousePos.y >= 262.5 &&
            mousePos.y <= 337.5 && Squares[8] == 0) {
          Squares[8] = turn;
          turn = turn + 1;
          if (turn > 2) turn = 1;
          PlaySound(Place);
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT) && GameOver) {
        if (mousePos.x >= 50 && mousePos.x <= 250 && mousePos.y >= 345 &&
            mousePos.y <= 395) {
          Winner = 0;
          GameOver = false;
          turn = 1;
    ...
    if (Scene == 3) {
      ...
      if (IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) {
        ...
        if (mousePos.x >= 0 && mousePos.x <= 400 && mousePos.y >= 115 &&
            mousePos.y <= 135) {
